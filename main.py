...
from wallet_mirror import monitor_mirror_wallets
...
jobs = [
    {"func": lambda: check_price_targets(updater.bot), "trigger": "interval", "minutes": 5},
    {"func": lambda: scan_new_tokens(updater.bot), "trigger": "interval", "minutes": 10},
    {"func": lambda: monitor_mirror_wallets(updater.bot), "trigger": "interval", "minutes": 10},
    {"func": lambda: detect_botnet_activity(updater.bot), "trigger": "interval", "minutes": 10},
    {"func": lambda: send_daily_report(updater.bot), "trigger": "cron", "hour": 9, "minute": 0, "timezone": "Asia/Bangkok"},
]
